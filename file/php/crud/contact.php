...
<body>
    ...
    <div class="row no-gutters">
        ...
        <divlass class="col-md-10 p-5 pt-2">
            ...
            <!-- Dasboard content -->
            <h3><i class="bi bi-chat-dots-fill mr-2"></i>Daftar Kritik & Saran</h3>
            <hr>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <!-- button delete -->
                                    <a href="proses_simpan.php?action=delete3&id=<?php echo $row['id']; ?>"><i class="bi bi-trash-fill bg-danger p-2 text-white rounded" data-toggle="tooltip" title="hapus" onclick="alert('Data Berhasil dihapus !')"></i>
                                    </a>
                                </td>
                            </tr>
                        <?php
