...
<body>
	...
	<div class="row no-gutters">
		...
		<div class="col-md-6 p-5 pt-2">
			...
			<hr>
			<form method="post" action="proses_simpan.php?action=update">
				<input type="hidden" name="id" value="<?php echo $data['id']; ?>" />
				<div class="form-group row">
					<label for="inputName" class="col-sm-3 col-form-label">Nama</label>
					<div class="col-sm-5">
						<input type="name" class="form-control" id="inputName" name="nama" value="<?php echo $data['nama']; ?>">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" id="inputText" name="posisi" value="<?php echo $data['posisi']; ?>">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" id="inputText" name="gaji" value="<?php echo $data['gaji']; ?>">
					</div>
				</div>
